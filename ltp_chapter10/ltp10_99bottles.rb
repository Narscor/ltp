# LTP Chapter 10 Exercise: Ninety-nine Bottles of Beer on the Wall

def english_number number
  if number < 0 # No negative numbers here.
  ...
  while zillions.length > 0
    ...
    left = left - write*zil_base    # Substract off those zillions
...
num_at_start = 5        # Change to other number if you want
